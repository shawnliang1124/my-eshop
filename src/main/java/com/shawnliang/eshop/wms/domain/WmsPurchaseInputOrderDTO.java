 ...
 */
@Data
public class WmsPurchaseInputOrderDTO implements Serializable {
    ...
    private List<WmsPurchaseInputPutOnItemDTO> inputPutOnItemDTOList;

    private List<WmsPurchaseInputOrderItemDTO> inputOrderItemDTOS;
}
