 ...
 * @date 2021/6/6 16:01
 */
public class SubmitOrderGoodsStockUpdater extends AbstractGoodsStockUpdaterCommand{
    ...
    public SubmitOrderGoodsStockUpdater(List<InventoryGoodsStockDO> inventoryGoodsStockDOS, InventoryGoodsStockManager inventoryGoodsStockManager, Map<Long, OrderItemDTO> orderItemDTOMap) {
