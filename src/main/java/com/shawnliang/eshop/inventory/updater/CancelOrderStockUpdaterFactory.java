...
public class CancelOrderStockUpdaterFactory<T>
    ...
    public CancelOrderStockUpdaterFactory(@Autowired InventoryGoodsStockManager inventoryGoodsStockManager) {
    ...
    protected GoodsStockUpdater createUpdater(List<InventoryGoodsStockDO> stockDOList, T params) {
        ...
        return new CancelOrderGoodsStockUpdater(stockDOList, inventoryGoodsStockManager, orderItemDTOMap);
    }
