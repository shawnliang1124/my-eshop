 ...
 * @date 2021/6/6 16:01
 */
public class CancelOrderGoodsStockUpdater extends AbstractGoodsStockUpdaterCommand{
    ...
    public CancelOrderGoodsStockUpdater(List<InventoryGoodsStockDO> inventoryGoodsStockDOS, InventoryGoodsStockManager inventoryGoodsStockManager, Map<Long, OrderItemDTO> orderItemDTOMap) {
    ...
    protected void updateSalesStockQuantity() {
        for (InventoryGoodsStockDO inventoryGoodsStockDO : inventoryGoodsStockDOS) {
            ...
            inventoryGoodsStockDO.setSaleStockQuantity(inventoryGoodsStockDO.getSaleStockQuantity() + orderItemDTO.getPurchaseQuantity());
        }
    }
